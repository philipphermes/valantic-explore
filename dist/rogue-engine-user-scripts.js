...
/* harmony import */ var three__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! three */ "three");
/* harmony import */ var _Pass_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Pass.js */ "./node_modules/three/examples/jsm/postprocessing/Pass.js");
/* harmony import */ var _shaders_SMAAShader_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shaders/SMAAShader.js */ "./node_modules/three/examples/jsm/shaders/SMAAShader.js");
...
class SMAAPass extends _Pass_js__WEBPACK_IMPORTED_MODULE_1__.Pass {
	...
	constructor( width, height ) {
		...
		this.edgesRT = new three__WEBPACK_IMPORTED_MODULE_0__.WebGLRenderTarget( width, height, {
			depthBuffer: false
		} );
		this.edgesRT.texture.name = 'SMAAPass.edges';

		this.weightsRT = new three__WEBPACK_IMPORTED_MODULE_0__.WebGLRenderTarget( width, height, {
			depthBuffer: false
		} );
		...
		this.areaTexture = new three__WEBPACK_IMPORTED_MODULE_0__.Texture();
		this.areaTexture.name = 'SMAAPass.area';
		this.areaTexture.image = areaTextureImage;
		this.areaTexture.minFilter = three__WEBPACK_IMPORTED_MODULE_0__.LinearFilter;
		...
		this.searchTexture = new three__WEBPACK_IMPORTED_MODULE_0__.Texture();
		this.searchTexture.name = 'SMAAPass.search';
		this.searchTexture.image = searchTextureImage;
		this.searchTexture.magFilter = three__WEBPACK_IMPORTED_MODULE_0__.NearestFilter;
		this.searchTexture.minFilter = three__WEBPACK_IMPORTED_MODULE_0__.NearestFilter;
		this.searchTexture.generateMipmaps = false;
		this.searchTexture.flipY = false;

		// materials - pass 1

		if ( _shaders_SMAAShader_js__WEBPACK_IMPORTED_MODULE_2__.SMAAEdgesShader === undefined ) {

			console.error( 'THREE.SMAAPass relies on SMAAShader' );

		}

		this.uniformsEdges = three__WEBPACK_IMPORTED_MODULE_0__.UniformsUtils.clone( _shaders_SMAAShader_js__WEBPACK_IMPORTED_MODULE_2__.SMAAEdgesShader.uniforms );

		this.uniformsEdges[ 'resolution' ].value.set( 1 / width, 1 / height );

		this.materialEdges = new three__WEBPACK_IMPORTED_MODULE_0__.ShaderMaterial( {
			defines: Object.assign( {}, _shaders_SMAAShader_js__WEBPACK_IMPORTED_MODULE_2__.SMAAEdgesShader.defines ),
			uniforms: this.uniformsEdges,
			vertexShader: _shaders_SMAAShader_js__WEBPACK_IMPORTED_MODULE_2__.SMAAEdgesShader.vertexShader,
			fragmentShader: _shaders_SMAAShader_js__WEBPACK_IMPORTED_MODULE_2__.SMAAEdgesShader.fragmentShader
		} );

		// materials - pass 2

		this.uniformsWeights = three__WEBPACK_IMPORTED_MODULE_0__.UniformsUtils.clone( _shaders_SMAAShader_js__WEBPACK_IMPORTED_MODULE_2__.SMAAWeightsShader.uniforms );
		...
		this.materialWeights = new three__WEBPACK_IMPORTED_MODULE_0__.ShaderMaterial( {
			defines: Object.assign( {}, _shaders_SMAAShader_js__WEBPACK_IMPORTED_MODULE_2__.SMAAWeightsShader.defines ),
			uniforms: this.uniformsWeights,
			vertexShader: _shaders_SMAAShader_js__WEBPACK_IMPORTED_MODULE_2__.SMAAWeightsShader.vertexShader,
			fragmentShader: _shaders_SMAAShader_js__WEBPACK_IMPORTED_MODULE_2__.SMAAWeightsShader.fragmentShader
		} );

		// materials - pass 3

		this.uniformsBlend = three__WEBPACK_IMPORTED_MODULE_0__.UniformsUtils.clone( _shaders_SMAAShader_js__WEBPACK_IMPORTED_MODULE_2__.SMAABlendShader.uniforms );

		this.uniformsBlend[ 'resolution' ].value.set( 1 / width, 1 / height );
		this.uniformsBlend[ 'tDiffuse' ].value = this.weightsRT.texture;

		this.materialBlend = new three__WEBPACK_IMPORTED_MODULE_0__.ShaderMaterial( {
			uniforms: this.uniformsBlend,
			vertexShader: _shaders_SMAAShader_js__WEBPACK_IMPORTED_MODULE_2__.SMAABlendShader.vertexShader,
			fragmentShader: _shaders_SMAAShader_js__WEBPACK_IMPORTED_MODULE_2__.SMAABlendShader.fragmentShader
		} );
...
class UnrealBloomPass extends _Pass_js__WEBPACK_IMPORTED_MODULE_1__.Pass {
	...
	constructor( resolution, strength, radius, threshold ) {
		...
		this.resolution = ( resolution !== undefined ) ? new three__WEBPACK_IMPORTED_MODULE_0__.Vector2( resolution.x, resolution.y ) : new three__WEBPACK_IMPORTED_MODULE_0__.Vector2( 256, 256 );

		// create color only once here, reuse it later inside the render function
		this.clearColor = new three__WEBPACK_IMPORTED_MODULE_0__.Color( 0, 0, 0 );
		...
		this.renderTargetBright = new three__WEBPACK_IMPORTED_MODULE_0__.WebGLRenderTarget( resx, resy );
		this.renderTargetBright.texture.name = 'UnrealBloomPass.bright';
		this.renderTargetBright.texture.generateMipmaps = false;

		for ( let i = 0; i < this.nMips; i ++ ) {

			const renderTargetHorizonal = new three__WEBPACK_IMPORTED_MODULE_0__.WebGLRenderTarget( resx, resy );
			...
			const renderTargetVertical = new three__WEBPACK_IMPORTED_MODULE_0__.WebGLRenderTarget( resx, resy );
		...
		const highPassShader = _shaders_LuminosityHighPassShader_js__WEBPACK_IMPORTED_MODULE_3__.LuminosityHighPassShader;
		this.highPassUniforms = three__WEBPACK_IMPORTED_MODULE_0__.UniformsUtils.clone( highPassShader.uniforms );

		this.highPassUniforms[ 'luminosityThreshold' ].value = threshold;
		this.highPassUniforms[ 'smoothWidth' ].value = 0.01;

		this.materialHighPassFilter = new three__WEBPACK_IMPORTED_MODULE_0__.ShaderMaterial( {
		...
		for ( let i = 0; i < this.nMips; i ++ ) {
			...
			this.separableBlurMaterials[ i ].uniforms[ 'texSize' ].value = new three__WEBPACK_IMPORTED_MODULE_0__.Vector2( resx, resy );
		...
		this.bloomTintColors = [ new three__WEBPACK_IMPORTED_MODULE_0__.Vector3( 1, 1, 1 ), new three__WEBPACK_IMPORTED_MODULE_0__.Vector3( 1, 1, 1 ), new three__WEBPACK_IMPORTED_MODULE_0__.Vector3( 1, 1, 1 ), new three__WEBPACK_IMPORTED_MODULE_0__.Vector3( 1, 1, 1 ), new three__WEBPACK_IMPORTED_MODULE_0__.Vector3( 1, 1, 1 ) ];
		...
		this.copyUniforms = three__WEBPACK_IMPORTED_MODULE_0__.UniformsUtils.clone( copyShader.uniforms );
		this.copyUniforms[ 'opacity' ].value = 1.0;

		this.materialCopy = new three__WEBPACK_IMPORTED_MODULE_0__.ShaderMaterial( {
	...
	getSeperableBlurMaterial( kernelRadius ) {
		...
		return new three__WEBPACK_IMPORTED_MODULE_0__.ShaderMaterial( {
			...
			uniforms: {
				...
				'texSize': { value: new three__WEBPACK_IMPORTED_MODULE_0__.Vector2( 0.5, 0.5 ) },
				'direction': { value: new three__WEBPACK_IMPORTED_MODULE_0__.Vector2( 0.5, 0.5 ) }
			},
...
UnrealBloomPass.BlurDirectionX = new three__WEBPACK_IMPORTED_MODULE_0__.Vector2( 1.0, 0.0 );
UnrealBloomPass.BlurDirectionY = new three__WEBPACK_IMPORTED_MODULE_0__.Vector2( 0.0, 1.0 );
